...
function Library.Indicators(): Indicators
    ...
    do
        ...
        Frame.InputBegan:Connect(function(Input: InputObject, Process: boolean)
        ...
        UserInput.InputChanged:Connect(function(Input: InputObject, Process: boolean)
            ...
            if not (UserInput:IsMouseButtonPressed(Enum.UserInputType.MouseButton1 or Enum.UserInput.UserInputType == Enum.UserInputType.Touch)) then
